            ...
            >
                    ...
                    <AnimatePresence custom={direction}>
                        {items.map((item, index) => {
                            ...
                            return (
                                <motion.div
                                    key={item.id}
                                    className="absolute inset-0 w-full h-full overflow-hidden border-[6px] bg-neutral-800 border-neutral-700 shadow-2xl rounded-2xl flex items-center justify-center p-1"
                                    initial={{
                ...
                <div className="col-start-2 row-start-2 flex flex-col justify-center min-h-[120px]">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <h3 className="text-xl font-bold dark:text-white text-white">{activeItem.title}</h3>
